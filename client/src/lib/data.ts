...
export const services: Service[] = [
  {
    ...
    image: "/assets/ceremonial-detail.webp",
...
export const builderSteps: BuilderStep[] = [
  {
    ...
    previewImage: "/assets/hero-chapel.webp",
    previewCaption: "A dignified beginning to a meaningful farewell.",
    options: [
      { id: "traditional", name: "Traditional Service", description: "Full visitation and funeral service.", price: 5000, image: "/assets/hero-chapel.webp" },
      { id: "memorial", name: "Memorial Service", description: "Gathering without the body present.", price: 3500, image: "/assets/ceremonial-detail.webp" },
      { id: "graveside", name: "Graveside Service", description: "Ceremony held at the burial site.", price: 2500, image: "/assets/service-graveside.webp" },
    ]
  },
  {
    id: "casket",
    ...
    previewImage: "/assets/casket-mahogany.webp",
    previewCaption: "Craftsmanship that honors a lifetime.",
    options: [
      { id: "mahogany", name: "Solid Mahogany", description: "Hand-crafted solid wood with velvet interior.", price: 4500, image: "/assets/casket-mahogany.webp" }, 
      { id: "oak", name: "Classic Oak", description: "Durable oak finish with crepe interior.", price: 3200, image: "/assets/casket-oak.webp" },
      { id: "metal", name: "Brushed Steel", description: "18-gauge steel with gasket protection.", price: 2800, image: "/assets/casket-metal.webp" },
    ]
  },
  {
    id: "flowers",
    ...
    previewImage: "/assets/flowers-seasonal.webp",
    previewCaption: "Nature's beauty as a final tribute.",
    options: [
      { id: "spray-red", name: "Red Rose Casket Spray", description: "Classic arrangement of deep red roses.", price: 450, image: "/assets/flowers-red-rose.webp" },
      { id: "wreath-white", name: "White Lily Wreath", description: "Elegant standing wreath of white lilies.", price: 350, image: "/assets/flowers-white-lily.webp" },
      { id: "spray-seasonal", name: "Seasonal Mixed Spray", description: "Vibrant mix of seasonal blooms.", price: 400, image: "/assets/flowers-seasonal.webp" },
    ]
  }
];
