...
export const builderSteps: BuilderStep[] = [
  {
    ...
    options: [
      { id: "traditional", name: "Traditional Service", description: "Full visitation and funeral service.", price: 5000 },
      { id: "memorial", name: "Memorial Service", description: "Gathering without the body present.", price: 3500 },
      { id: "graveside", name: "Graveside Service", description: "Ceremony held at the burial site.", price: 2500 },
    ]
  },
  {
    id: "casket",
    ...
    options: [
      { id: "mahogany", name: "Solid Mahogany", description: "Hand-crafted solid wood with velvet interior.", price: 4500, image: "/assets/texture-marble.png" }, // Mock image
  ...
  },
  {
    ...
    options: [
      { id: "spray-red", name: "Red Rose Casket Spray", description: "Classic arrangement of deep red roses.", price: 450 },
      { id: "wreath-white", name: "White Lily Wreath", description: "Elegant standing wreath of white lilies.", price: 350 },
      { id: "spray-seasonal", name: "Seasonal Mixed Spray", description: "Vibrant mix of seasonal blooms.", price: 400 },
    ]
  }
];
