...
async function seedServiceCatalog() {
  ...
  await db.insert(serviceCatalog).values([
    ...
    { itemType: "add-on", name: "Additional Viewing Hours", description: "Extended viewing time (per hour).", category: "facility", defaultPrice: "200.00", displayOrder: 42 },
    ...
    { itemType: "add-on", name: "Prayer Cards (set of 100)", description: "Personalized laminated prayer cards.", category: "stationery", defaultPrice: "175.00", displayOrder: 46 },
    { itemType: "add-on", name: "Memorial Candles (set of 12)", description: "Personalized memorial candles for family and friends.", category: "memorial", defaultPrice: "200.00", displayOrder: 47 },
    ...
    { itemType: "cash-advance", name: "Additional Death Certificates (each)", description: "Additional certified copies beyond initial 5.", category: "government", defaultPrice: "25.00", displayOrder: 51 },
